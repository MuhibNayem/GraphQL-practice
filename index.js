...
const typeDefs = gql` # this is called schema. which means how the data will be looks like
    type Query {
        hello: String 
        numberOfEmployee: Int
        salary: Float
        isExperienced: Boolean
        experienceFields: [String!]! #this means the array cant be null and also there will be no nul value in the array
...
`;
const resolvers = { // this is the actual method by which we return the data
    Query: {
        hello: () => {
            return "World !!!"
        },
        ...
        experienceFields: () => {
            return ["react.js", "node.js", "java", "html", "AWS"]
        },
        products: () => {
            return products;
        }
